  ...
  const deliveryMethods = [
    {
      ...
      description: 'Доставка курьером в течение 2-3 рабочих дней',
      price: 300,
      minOrderAmount: 0,
      maxWeight: 5,
      status: 'active',
        ...
        <div className="lg:col-span-1">
          {selectedMethod ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center text-gray-500 dark:text-gray-400">
              Выберите метод доставки для просмотра деталей
            </div>
          )}
        </div>
      </div>

      {/* Модальное окно добавления метода доставки */}
      {isAddingMethod && (
